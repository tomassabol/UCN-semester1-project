...
import gui.windows.model.CustomerTypeUI;
 ...
 *
 */
public class CRUDCustomerTypes extends JPanel {
	 ...
	 * Create the dialog.
	 */
	public CRUDCustomerTypes(AuthenticationController auth) {
		this.auth = auth;
		...
		gbc_btnAddCustomerType.gridx = 2;
	...
	public void setTableModel(CustomerTypeTableModel tableModel) {
	...
	private void addEventHandlers() {
		...
		btnAddCustomerType.addActionListener(e -> {
			...
			frame.setVisible(true);
			if (frame.getCustomerType() != null) {
				tableModel.add(frame.getCustomerType());
				setTableModel(tableModel);
			}
		});
