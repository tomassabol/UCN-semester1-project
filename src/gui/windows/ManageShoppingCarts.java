 ...
 *
 */
public class ManageShoppingCarts extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public ManageShoppingCarts(AuthenticationController auth, Customer customer) {
		this.auth = auth;
	...
	private void addItem() {
		ChooseItems frame = new ChooseItems(auth, customer);
