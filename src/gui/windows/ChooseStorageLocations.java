 ...
 *
 */
public class ChooseStorageLocations extends JDialog {
	
	private static final long serialVersionUID = 2968937672159813565L;
	private final JPanel contentPane;
	private CRUDStorageLocations CRUDPanel;
	 ...
	 * Create the dialog.
	 */
	public ChooseStorageLocations(AuthenticationController auth) {
		this.auth = auth;
		...
		CRUDPanel = new CRUDStorageLocations(auth);
