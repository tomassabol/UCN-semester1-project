...
public class ManageSupplyOfferUI extends JDialog {

	private SupplyController supplyCtrl;
	
	private final JPanel contentPane;
	private CRUDSupplyOfferPanel CRUDPanel;
	 ...
	 * Create the dialog.
	 */
	public ManageSupplyOfferUI(AuthenticationController auth, Product product) {
		this.auth = auth;
		...
		CRUDPanel = new CRUDSupplyOfferPanel(auth, product);
